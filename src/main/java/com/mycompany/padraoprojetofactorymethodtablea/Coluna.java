 ...
 */
/**
 * Interface a ser implementada para representar uma coluna de uma tabela em um
 * determinado formato, como HTML, CSV, XML, AsciiDoc, Markdown, etc.
 *
...
public interface Coluna {
    ...
    /**
     * Obtém o título a ser exibido na coluna da tabela. Por padrão, o título é
     * o nome do atributo dos objetos contidos na lista de dados sendo
     * exportados.
     *
     * @return
     *
    ...
    /**
     * Altera o título a ser exibido na coluna da tabela. Por padrão, o título é
     * o nome do atributo dos objetos contidos na lista de dados sendo
     * exportados.
     *
    ...
    /**
     * Gera o código para representar o título da coluna em um formato
     * específico.
     *
     * @return
     */
    ...
    /**
     * Gera o código para representar a coluna em um formato específico,
     * contendo o dado armazenado em um atributo de um objeto da lista a ser
     * exportada.
     *
     * @param produto produto de onde o valor de um determinado campo será obtido
